...
class ResourceFinder:
    ...
    def __init__(self):
        if self._base_paths is None:
            ...
            logger.debug(f"资源查找器初始化，基础路径: {[str(p) for p in self._base_paths]}")
    ...
    def find_resource(self, resource_path: Union[str, Path], 
                     resource_type: str = "file") -> Optional[Path]:
        """
        查找资源文件或目录
    ...
    def list_files_in_directory(self, dir_path: Union[str, Path], 
