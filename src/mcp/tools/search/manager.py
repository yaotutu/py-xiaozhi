...
class SearchManager:
    ...
    def init_tools(self, add_tool, PropertyList, Property, PropertyType):
        ...
        初始化并注册所有搜索工具.
        """
        from .tools import search_bing, fetch_webpage_content, get_search_results
    ...
    async def search(self, query: str, num_results: int = 5, language: str = "zh-cn", region: str = "CN") -> List[SearchResult]:
        """
        执行搜索并缓存结果.
